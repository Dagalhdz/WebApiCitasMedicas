    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MedicoInfo = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PacientesInfo = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FamiliarId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Familiares_Pacientes_FamiliarId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InformacionPacientes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InformacionPacientes_Pacientes_PacienteId",
                        column: x => x.PacienteId,
                        principalTable: "Pacientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicosPacientes_Medicos_MedicoId",
                        column: x => x.MedicoId,
                        principalTable: "Medicos",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MedicosPacientes_Pacientes_PacienteId",
                        column: x => x.PacienteId,
                        principalTable: "Pacientes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "HistorialPacientes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InformacionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistorialPacientes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistorialPacientes_InformacionPacientes_InformacionId",
                        column: x => x.InformacionId,
                        principalTable: "InformacionPacientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MedicoPacienteId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Citas_MedicosPacientes_MedicoPacienteId",
                        column: x => x.MedicoPacienteId,
                        principalTable: "MedicosPacientes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Citas_MedicoPacienteId",
                table: "Citas",
                column: "MedicoPacienteId");

            migrationBuilder.CreateIndex(
                name: "IX_Familiares_FamiliarId",
                table: "Familiares",
                column: "FamiliarId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistorialPacientes_InformacionId",
                table: "HistorialPacientes",
                column: "InformacionId");

            migrationBuilder.CreateIndex(
                name: "IX_InformacionPacientes_PacienteId",
                table: "InformacionPacientes",
                column: "PacienteId");
